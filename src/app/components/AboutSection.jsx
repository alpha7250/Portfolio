...
import { 
  FaNodeJs, FaReact, FaDatabase, FaJsSquare, FaUniversity, 
  FaGraduationCap, FaSchool, FaAward 
} from "react-icons/fa";
    ...
    content: (
      <ul className="grid grid-cols-3 gap-6 mt-6 text-white">
        {[
          ...
          <li key={label} className="flex items-center space-x-3 text-lg bg-gray-700 p-3 rounded-lg shadow-md">
            {icon}
            <span>{label}</span>
          </li>
        ))}
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {[
          ...
          },
          {
            ...
            title: "Class 12th",
            subtitle: "Himalayan Public School, CBSE - 83%",
          },
          {
            icon: <FaSchool className="text-yellow-400" />,
            title: "Class 10th",
            subtitle: "B D Public School, CBSE - 97%",
          },
        ].map(({ icon, title, subtitle }) => (
          <div key={title} className="bg-gray-800 p-5 rounded-lg shadow-lg flex items-center space-x-4">
        ...
        {[
          {
            ...
            subtitle: "Ranked in the top 5%, awarded Gold Medal",
          },
          {
            icon: <SiUdemy className="text-blue-500" />,
            title: "C++ Programming - Udemy",
            subtitle: "Demonstrated proficiency in Object-Oriented Development.",
          },
        ].map(({ icon, title, subtitle }) => (
          <div key={title} className="bg-gray-800 p-5 rounded-lg shadow-lg flex items-center space-x-4">
            <div className="text-4xl">{icon}</div>
  ...
  return (
    <section className="text-white py-16 px-6 lg:px-16" id="about">
      <div className="md:grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          <Image src="/images/about-image.png" width={500} height={500} alt="About Me" className="rounded-lg shadow-lg" />
        </motion.div>
        ...
        <div className="mt-6 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            I am a <span className="text-blue-400 font-semibold">Full Stack Web Developer</span> with a passion for 
            building interactive and responsive web applications. I have hands-on experience with 
            <span className="text-green-400 font-semibold"> JavaScript, React, Node.js, Express, PostgreSQL, MongoDB, and more.</span>  
            I thrive in team environments and am always eager to expand my skill set. 
          </p>
